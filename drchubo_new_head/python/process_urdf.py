...
model.copy_chain_with_rottrans('Body_RWR','Body_RF13',[pi,0,0],[0,0,0],rightmask,leftmask,'rotx')
model.copy_chain_with_rottrans('Body_RWR','Body_RF23',[pi,0,0],[0,0,0],rightmask,leftmask,'rotx')
model.copy_chain_with_rottrans('Body_RWR','Body_RF33',[pi,0,0],[0,0,0],rightmask,leftmask,'rotx')

model.joints['LF11'].axis*=-1
model.joints['LF21'].axis*=-1
model.joints['LF31'].axis*=-1
#model.joints['LF12'].axis*=-1
#model.joints['LF22'].axis*=-1
#model.joints['LF32'].axis*=-1
#model.joints['LF13'].axis*=-1
#model.joints['LF23'].axis*=-1
#model.joints['LF33'].axis*=-1
...
model.write_xml('drchubo_v3.urdf')
model.write_openrave_files('drchubo_v3')
